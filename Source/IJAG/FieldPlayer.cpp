...
void AFieldPlayer::UpdateCharacterRotation(float DeltaTime)
{
    if (GetCharacterMovement()->GetCurrentAcceleration().Size() > KINDA_SMALL_NUMBER)
    {
        ...
        const FRotator NewRotation = FMath::RInterpTo(
            ...
            TargetRotation,
            DeltaTime,
            12.0f // Rotation speed (degrees per second)
        );
